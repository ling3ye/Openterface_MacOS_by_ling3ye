...
class KeyboardMapper {
    ...
    func fromSpecialKeyToKeyCode(code: SpecialKey) -> UInt16? {
        ...
        case .F2:
            return UInt16(kVK_F2)
        case .F3:
            return UInt16(kVK_F3)
        case .F4:
            return UInt16(kVK_F4)
        case .F5:
            return UInt16(kVK_F5)
        case .F6:
            return UInt16(kVK_F6)
        case .F7:
            return UInt16(kVK_F7)
        case .F8:
            return UInt16(kVK_F8)
        case .F9:
            return UInt16(kVK_F9)
        case .F10:
            return UInt16(kVK_F10)
        case .F11:
            return UInt16(kVK_F11)
        case .F12:
            return UInt16(kVK_F12)
        case .CtrlAltDel:
